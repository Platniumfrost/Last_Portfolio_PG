...
meteor_list = ['meteorBrown_big1.png', 'meteorBrown_big2.png', 'meteorBrown_big3.png',
               'meteorBrown_med1.png', 'meteorBrown_med3.png', 'meteorBrown_tiny1.png',
...
powerup_images = {}
powerup_images['shield'] = pg.image.load(path.join(img_dir, 'shield_gold.png'))
powerup_images['gun'] = pg.image.load(path.join(img_dir, 'bolt_gold.png'))
#     load all sound
shoot_sound = pg.mixer.Sound(path.join(snd_dir, 'pew.wav'))
expl_sounds = []
